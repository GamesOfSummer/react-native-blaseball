...
import HallOfFlame from "../screens/HallOfFlame";
  ...
  return (
    <TabTwoStack.Navigator>
      <TabTwoStack.Screen
        ...
        options={{ headerTitle: "Snacks" }}
      />
    </TabTwoStack.Navigator>
  );
}

const TabTwoStackBroken = createStackNavigator<TabTwoParamList>();
  ...
  return (
    <TabTwoStack.Navigator>
      <TabTwoStack.Screen
        name="HallOfFlame"
        component={HallOfFlame}
        options={{ headerTitle: "Hall of Flame" }}
      />
    </TabTwoStack.Navigator>
  );
}
